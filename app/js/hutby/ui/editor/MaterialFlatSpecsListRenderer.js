...
define([
    ...
    function MaterialFlatSpecsListRenderer(){
        ...
        var header = $('<h3 class="mdl-color-text--purple-500">Комплектация и инфраструктура</h3>');
        var list = $('<ul></ul>');
        ...
        _this.visitOverview = function(overview) {
            _.each(overview.specs(), function(feature){
                var li = $('<li></li>');
            ...
            var add = $(
                '<div class="mdl-card__actions mdl-card--border">'+
                    '<a href="#" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-color-text--purple-500">Добавить</a>'+
                '</div>');
            html.append(add);
    ...
    return MaterialFlatSpecsListRenderer;
});